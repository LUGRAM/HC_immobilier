...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\HP\Desktop\Rigel\backend\public\storage' => 'string',
            ...
            'services.cinetpay.mode' => 'string',
            'services.cinetpay.api_key' => 'string',
            'services.cinetpay.site_id' => 'string',
            'services.cinetpay.secret_key' => 'string',
            'services.cinetpay.api_url' => 'string',
            'services.cinetpay.check_url' => 'string',
            'services.cinetpay.notify_url' => 'string',
            'services.cinetpay.return_url' => 'string',
            'services.cinetpay.cancel_url' => 'string',
            'services.onesignal.app_id' => 'string',
            'services.onesignal.api_key' => 'string',
            'services.redis.client' => 'string',
            'services.redis.options.cluster' => 'string',
            'services.redis.options.prefix' => 'string',
            'services.redis.default.host' => 'string',
            'services.redis.default.password' => 'NULL',
            'services.redis.default.port' => 'string',
            'services.redis.default.database' => 'string',
            'services.redis.cache.host' => 'string',
            'services.redis.cache.password' => 'NULL',
            'services.redis.cache.port' => 'string',
            'services.redis.cache.database' => 'string',
            'services.redis.session.host' => 'string',
            'services.redis.session.password' => 'NULL',
            'services.redis.session.port' => 'string',
            'services.redis.session.database' => 'string',
            'services.redis.queue.host' => 'string',
            'services.redis.queue.password' => 'NULL',
            'services.redis.queue.port' => 'string',
            'services.redis.queue.database' => 'string',
...
'view','create','cancel','approve','terminate',
'pay','update',);
...
'filesystems.disks.s3.report','filesystems.links.C:\\Users\\HP\\Desktop\\Rigel\\backend\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'services.slack.notifications.channel','services.cinetpay.mode','services.cinetpay.api_key','services.cinetpay.site_id','services.cinetpay.secret_key',
'services.cinetpay.api_url','services.cinetpay.check_url','services.cinetpay.notify_url','services.cinetpay.return_url','services.cinetpay.cancel_url',
'services.onesignal.app_id','services.onesignal.api_key','services.redis.client','services.redis.options.cluster','services.redis.options.prefix',
'services.redis.default.host','services.redis.default.password','services.redis.default.port','services.redis.default.database','services.redis.cache.host',
'services.redis.cache.password','services.redis.cache.port','services.redis.cache.database','services.redis.session.host','services.redis.session.password',
'services.redis.session.port','services.redis.session.database','services.redis.queue.host','services.redis.queue.password','services.redis.queue.port',
'services.redis.queue.database','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'filament.pages.manage-settings','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Users.HP.Desktop.Rigel.backend.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'DB_USERNAME','DB_PASSWORD','CACHE_STORE','SESSION_DRIVER','SESSION_LIFETIME',
'SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','QUEUE_CONNECTION','BROADCAST_CONNECTION',
'FILESYSTEM_DISK','REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT',
'REDIS_DB','REDIS_CACHE_DB','REDIS_SESSION_DB','REDIS_QUEUE_DB','MAIL_MAILER',
'MAIL_SCHEME','MAIL_HOST','MAIL_PORT','MAIL_USERNAME','MAIL_PASSWORD',
'MAIL_ENCRYPTION','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','SANCTUM_STATEFUL_DOMAINS','CINETPAY_MODE',
'CINETPAY_API_KEY','CINETPAY_SITE_ID','CINETPAY_SECRET_KEY','CINETPAY_API_URL','CINETPAY_CHECK_URL',
'CINETPAY_NOTIFY_URL','CINETPAY_RETURN_URL','CINETPAY_CANCEL_URL','ONESIGNAL_APP_ID','ONESIGNAL_API_KEY',
'AWS_ACCESS_KEY_ID','AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT',
'VITE_APP_NAME','VISIT_FEE_AMOUNT','VISIT_FEE_REQUIRED','LATE_PAYMENT_PENALTY_RATE','LATE_PAYMENT_GRACE_PERIOD_DAYS',
'PAGINATION_PER_PAGE','MAX_UPLOAD_SIZE','ALLOWED_IMAGE_TYPES',);
